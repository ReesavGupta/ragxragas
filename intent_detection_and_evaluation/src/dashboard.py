...
col3.metric("Total Time (s)", f"{summary['total_time']:.2f}")
col4.metric("Total Queries", summary['total'])
...
st.dataframe(filtered[['id', 'query', 'true_intent', 'predicted_intent', 'is_correct_intent', 'answer', 'response_time']]) 